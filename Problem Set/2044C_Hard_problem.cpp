...
void solve() {
        ...
        // Step 1: Seat monkeys with strict preferences for row 1 and row 2
        ll row1_seats = min(m, a); // Monkeys strictly for row 1
        ll row2_seats = min(m, b); // Monkeys strictly for row 2

        // Step 2: Calculate remaining seats in each row
        ll remaining_row1 = m - row1_seats;
        ll remaining_row2 = m - row2_seats;

        // Step 3: Seat the no-preference monkeys
        ll no_pref_seats = min(c, remaining_row1 + remaining_row2);

        // Total seated monkeys
        ll total_seated = row1_seats + row2_seats + no_pref_seats;
