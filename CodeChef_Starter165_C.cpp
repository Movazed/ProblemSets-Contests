...
#define nl std::endl
#define SORT(arr) std::sort(arr.begin(), arr.end())
...
{return sqrt(square(x2-x1)+square(y2-y1)+square(z2-z1));} 
 #define COST(arr, idx) (max(0LL, arr[idx] - idx))
...
void solve() {
    // Apply code only for the testcase part; loop is in the main function
    ll size;
    INPUT >> size; 
