...
#define INPUT(m, a, b, c) cin >> m >> a >> b >> c
#define MIN(val1, val2) min(val1, val2)
#define CALC_REMAINING(seat_capacity, row_seats) (seat_capacity - row_seats)
#define CALC_TOTAL_SEATED(row1_seats, row2_seats, no_pref_seats) (row1_seats + row2_seats + no_pref_seats)
#define OUTPUT(result) cout << result << "\n"
// -------------------------<RNG>------------------------- 
...
void solve() {
    ...
    ll remaining_row1 = CALC_REMAINING(m, row1_seats); 
    ll remaining_row2 = CALC_REMAINING(m, row2_seats); 

    ll no_pref_seats = MIN(c, remaining_row1 + remaining_row2); 

    ll total_seated = CALC_TOTAL_SEATED(row1_seats, row2_seats, no_pref_seats); 
